...
@pytest.mark.parametrize(
    ...
    [
        ...
        "common_mode_voltage_available",
    ],
)
def test_ad7768_1_attr_available(
...
@pytest.mark.iio_hardware(hardware)
@pytest.mark.parametrize("classname", [(classname)])
@pytest.mark.parametrize("channel", ["channel[0]"])
@pytest.mark.parametrize("attr", ["value", "scale"])
def test_ad7768_1_channel_attr(
